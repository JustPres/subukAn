  ...
  return (
    <div className="min-h-screen bg-[#fcfcfc] text-[#1a1a1a] p-4 sm:p-8 max-w-6xl mx-auto space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="lg:col-span-2 bg-[#0F172A] border border-slate-800 shadow-xl rounded-2xl p-6 relative overflow-hidden flex flex-col justify-between min-h-[220px]">
          ...
          <div className="relative z-10 flex justify-between items-start">
            <div className="space-y-1">
              <div className="flex items-center gap-2">
                ...
                <span className="text-xs text-indigo-200/80 font-semibold px-2 py-0.5 bg-indigo-500/10 border border-indigo-500/20 rounded-md">Escrow Wallet</span>
              </div>
          ...
          <div className="relative z-10 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 pt-4 border-t border-slate-800">
            ...
            <button
              ...
              className="w-full sm:w-auto px-4 py-2 bg-white hover:bg-slate-100 text-slate-900 rounded-[8px] text-xs font-bold shadow-md transition-all whitespace-nowrap flex items-center justify-center gap-1.5 hover:-translate-y-0.5 active:translate-y-0"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 lg:grid-cols-1 gap-4">
          ...
          <div className="bg-white border border-slate-200/80 rounded-[12px] p-4 shadow-sm hover-lift flex flex-col justify-between">
