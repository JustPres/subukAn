...
| 2 | M2: R1 Claim Button UI | Implement dynamic state-aware claim buttons in tester dashboard | M1 | IN_PROGRESS |
| 3 | M3: R2 Task Workspace UI | Implement distinct submission status screens in task workspaces | M1 | PLANNED |
